"""
Ablation backtest for funding rate momentum rules against the flat-65 baseline.
...
Rules tested:
  funding_momentum_16: EWMAC(16,64) on annualised funding rate — short-term trend
  funding_momentum_32: EWMAC(32,128) on annualised funding rate — medium-term trend

Usage:
  python scripts/run_funding_momentum_ablation.py
"""
...
logger = logging.getLogger("funding_momentum_ablation")

_RULES = ["funding_momentum_16", "funding_momentum_32"]
...
def run_ablation(
    ...
    out_dir: str = "out/funding_momentum_ablation",
):
    ...
    print(f"\n{'='*70}")
    print(f"FUNDING MOMENTUM ABLATION RESULTS  (flat-65 baseline: "
...
def main():
    ...
    parser.add_argument("--outdir", default="out/funding_momentum_ablation")
