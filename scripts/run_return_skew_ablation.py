"""
Ablation backtest for return_skew_20 and return_skew_60 against the flat-64 baseline.

Both rules exist in trading_rules but were rejected in Pass 1 (predictive accuracy audit)
as "Bad reversion" before the flat-64 ensemble was established. Retesting to confirm.

Baseline: flat-64 at Sharpe=1.4325, Calmar=2.2198, MaxDD=-6.46%

Usage:
  python scripts/run_return_skew_ablation.py
"""
...
logger = logging.getLogger("return_skew_ablation")

_RULES = ["return_skew_20", "return_skew_60"]
...
def run_ablation(
    ...
    out_dir: str = "out/return_skew_ablation",
):
...
def main():
    ...
    parser.add_argument("--outdir", default="out/return_skew_ablation")
